...
class PetFriends:
    ...
    #     """Метод отправляет (постит) на серевер данные о добавляемом питомце, но без фото,
    #     и возвращает статус запроса на сервер, и результат в формате JSON с данными
    ...
    def add_photo_of_pet(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        '''Метод позволяет отправить запрос на сервер о добавлении фото карточки питомца по ID питомца и
